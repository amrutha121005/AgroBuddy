                ...
                <div class="col-lg-9">
                    <div class="card soil-info-card">
                        ...
                        <div class="card-footer bg-white">
                            <p class="text-muted mb-0"><small><i class="fas fa-info-circle me-1"></i>Source: National Bureau of Soil Survey and Land Use Planning (NBSS&LUP)</small></p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="card soil-info-card">
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="mb-0">Hover over any state in the map to view detailed information about its soil type, characteristics, and suitable crops.</p>
                        </div>
                    </div>
                </div>
            </div>
